...
public class EmployeeDetailPanel extends JPanel {
    ...
    EmployeeDetailPanel(Employee t, ArrayList<CompetenceEmployee> competenceEmployees) {
        Font font = Main.font;
        del = new JLabel();
        ...
        if (t != null) {
            ...
            String[][] arrayCompetences = new String[competenceEmployees.size()][5];
            for (int i = 0; i < competenceEmployees.size(); i++) {
                arrayCompetences[i] = competenceEmployees.get(i).toArray1();
            }
