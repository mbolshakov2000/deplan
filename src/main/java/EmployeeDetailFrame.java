...
class EmployeeDetailFrame extends JFrame {
    EmployeeDetailFrame(Employee t) {
        Main.closingWindowEmployee = 0;
...
//                if (phone == null)
//                    phone = "Не определен";
                    competenceEmployees.add(new CompetenceEmployee(employee_id,id,abbreviation, name, level_id, level, score, date));
                }
        ...
        if (t == null)
            ...
            setSize(1000, 620);
        EmployeeDetailPanel panel = new EmployeeDetailPanel(t, competenceEmployees);
        add(panel);
        setVisible(true);
...
//        panel.competenceTable.setListData(employees.toArray());
        ...
        panel.competenceAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EmployeeCompetenceFrame tcframe = new EmployeeCompetenceFrame(t);
                ...
                tcframe.addWindowListener(new java.awt.event.WindowAdapter() {
                    public void windowClosed(WindowEvent e) {
                        setVisible(false);
                        dispose();
                        EmployeeDetailFrame tframe = new EmployeeDetailFrame(t);
                        tframe.setLocationRelativeTo(null);
                        tframe.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
                        Main.closingWindowEmployee = 1;
                    }
                });
            }
        });
        ...
        panel.competenceDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Connection c = DriverManager.getConnection(Main.URL, Main.USER, Main.PASSWORD);
                Statement s = c.createStatement();
                String selectID = competenceEmployees.get(panel.competenceTable.getSelectedRow()).id;
                String selectDate = "TO_DATE('"+ competenceEmployees.get(panel.competenceTable.getSelectedRow()).date+"', 'YYYY-MM-DD')";
