...
public class MainPanel extends JPanel {
    JLabel openLabel, employeesLabel, coursesLabel, competencesLabel, dbLabel, analysisLabel, del1, del2, del3, del4, del5,
    openButton, employeesButton, coursesButton, competencesButton, dbButton, analysisButton, del6, del7, del8, del9, del10, del11;
    ...
    MainPanel() {
        ...
        del6 = new JLabel();
        del6.setPreferredSize(new Dimension(20, 20));
        del7 = new JLabel();
        del7.setPreferredSize(new Dimension(70, 20));
        del8 = new JLabel();
        ...
        coursesLabel = new JLabel("Список мероприятий");
        ...
        if (Objects.equals(dbLabel.getText(), "Подключение к базе данных не установлено")) {
            ...
            try {
                ...
                employeesButton = new JLabel(new ImageIcon(myPicture6));
                add(employeesButton);
                add(del5);
                employeesButton.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                employeesButton.addMouseListener(new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        EmployeesFrame answerFrame = new EmployeesFrame();
                        answerFrame.setLocationRelativeTo(null);
                        answerFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
                    }
                });
