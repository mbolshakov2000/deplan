...
@Data
@AllArgsConstructor
public class EventCompetencePanel extends JPanel {
    JLabel nameLabel, name2Label, levelLabel, resultLabel, del, del1, del2, del3;
    JButton cancel, submit;
    JComboBox nameField, levelField, resultField;
    EventCompetencePanel() {
        Font font = Main.font;
        del = new JLabel();
        ...
        levelLabel = new JLabel("Уровень с: ");
        ...
        resultLabel = new JLabel("Ожидаемый результат: ");
        resultLabel.setFont(font);
        resultLabel.setPreferredSize(new Dimension(200, 30));
        resultField = new JComboBox(new String[]{"Слабый уровень", "Недостаточный уровень", "Пороговый (начальный) уровень",
                "Базовый (средний) уровень", "Продвинутый уровень"});
        resultField.setFont(font);
        resultField.setPreferredSize(new Dimension(700,30));
        ...
        resultField.setSelectedIndex(0);
        add(nameLabel);
        add(nameField);
